...
export default async function CommandCenterPage() {
  ...
  const activeExperimentLanes = projects.filter((p) => p.experiment_status === "running").length;
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        {[
          ...
          { label: "Exp Lanes",        value: activeExperimentLanes, color: activeExperimentLanes > 0 ? "var(--tron-accent)" : "var(--tron-text-dim)", href: "/research" },
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-0.5 flex items-center gap-2">
                      ...
                      {p.experiment_status === "running" && (
                        <>
                          <span style={{ color: "var(--tron-text-dim)" }}>·</span>
                          <span className="text-[10px] font-mono" style={{ color: "var(--tron-accent)" }}>
                            EXP {p.active_experiment_id ?? "running"}
                          </span>
                        </>
                      )}
                    </div>
