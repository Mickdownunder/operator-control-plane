        ...
        >
          <div className="mb-3 flex items-center justify-between">
            ...
            <span
              ...
              style={{
                background:
                  project.experiment_summary.lane_status === "running" || project.experiment_summary.lane_status === "candidate_improved"
                    ? "color-mix(in srgb, var(--tron-accent) 20%, transparent)"
                    : project.experiment_summary.lane_status === "improved" && project.experiment_summary.epistemic_status === "confirmed"
                      ? "color-mix(in srgb, var(--tron-success) 20%, transparent)"
                      : project.experiment_summary.lane_status === "inconclusive"
                        ? "color-mix(in srgb, var(--tron-amber, #f59e0b) 20%, transparent)"
                        : "color-mix(in srgb, var(--tron-error, #ef4444) 20%, transparent)",
                color:
                  project.experiment_summary.lane_status === "running" || project.experiment_summary.lane_status === "candidate_improved"
                    ? "var(--tron-accent)"
                    : project.experiment_summary.lane_status === "improved" && project.experiment_summary.epistemic_status === "confirmed"
                      ...
                      : project.experiment_summary.lane_status === "inconclusive"
                        ...
                        : "var(--tron-error, #ef4444)",
                border: "1px solid var(--tron-border)",
              }}
            >
              {project.experiment_summary.lane_status === "candidate_improved"
                ? "Candidate improved"
                : project.experiment_summary.lane_status === "running"
                  ? "Sandbox running"
                  : project.experiment_summary.lane_status === "improved" && project.experiment_summary.epistemic_status === "confirmed"
                    ? "Confirmed improved"
                    : project.experiment_summary.lane_status === "inconclusive"
          ...
          <div className="grid grid-cols-2 gap-4 text-sm sm:grid-cols-5">
            <div>
              <div className="metric-label mb-1">Runs</div>
              ...
              <p className="text-[10px] mt-0.5" style={{ color: "var(--tron-text-dim)" }}>
                Bounded sandbox + confirm runs
              </p>
            </div>
            <div>
              <div className="metric-label mb-1">Lane</div>
              <div className="font-mono font-semibold text-[12px]" style={{ color: "var(--tron-text)" }}>
                {project.experiment_summary.experiment_id ?? "—"}
              </div>
              <p className="text-[10px] mt-0.5" style={{ color: "var(--tron-text-dim)" }}>
                {project.experiment_summary.lane_status ?? "—"}
              </p>
            </div>
            <div>
              <div className="metric-label mb-1">Epistemic</div>
              <div className="font-mono font-semibold text-[12px]" style={{ color: "var(--tron-text)" }}>
                {project.experiment_summary.epistemic_status ?? "—"}
              </div>
              <p className="text-[10px] mt-0.5" style={{ color: "var(--tron-text-dim)" }}>
                {project.experiment_summary.reason_code ?? project.experiment_summary.terminal_reason ?? "bounded experiment lane"}
              </p>
            </div>
            <div>
              <div className="metric-label mb-1">Metric</div>
              <div className="font-mono font-semibold text-[12px]" style={{ color: "var(--tron-text)" }}>
                {project.experiment_summary.metric_name
                  ? `${project.experiment_summary.metric_name}${project.experiment_summary.metric_value != null ? ` = ${project.experiment_summary.metric_value}` : ""}`
                  : "—"}
              </div>
              <p className="text-[10px] mt-0.5" style={{ color: "var(--tron-text-dim)" }}>
                terminal: {project.experiment_summary.status ?? "—"}
              </p>
            </div>
            <div>
              <div className="metric-label mb-1">Sub-agents</div>
              <div className="font-mono font-semibold" style={{ color: "var(--tron-text)" }}>
          ...
          <p className="mt-3 text-[11px]" style={{ color: "var(--tron-text-dim)" }}>
            The experiment lane is subordinate to June/Operator control. Candidate improvement is not promoted globally until confirmation succeeds; the project view now reflects lane status, epistemic status, and normalized reason codes directly from Operator truth.
          </p>
        </div>
      )}
