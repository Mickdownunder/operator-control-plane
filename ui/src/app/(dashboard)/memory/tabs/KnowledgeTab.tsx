  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="tron-panel p-6 flex flex-col">
        ...
        {loading.entities ? (
          <div className="text-tron-dim text-sm">Loading entities...</div>
        ) : (
          <>
            <div className="overflow-x-auto flex-1">
              ...
              {allEntities.length === 0 && <p className="text-tron-dim mt-2">No entities yet.</p>}
            </div>
      ...
      <div className="flex flex-col gap-6">
        {/* Playbooks */}
        <div className="tron-panel p-6 flex flex-col">
          <h2 className="mb-4 text-lg font-medium text-tron-muted">Applied Playbooks</h2>
          <div className="flex-1">
            ...
            {allPlaybooks.length === 0 && (
              <p className="text-tron-dim text-sm">No playbooks yet.</p>
            )}
          </div>
          <div className="mt-auto">
        ...
        <div className="tron-panel p-6 flex flex-col">
          ...
          {loading.outcomes ? (
            <div className="text-tron-dim text-sm">Loading outcomes...</div>
          ) : (
            <>
              <div className="flex-1">
                ...
                {allOutcomes.length === 0 && <p className="text-tron-dim text-sm mt-2">No outcomes yet.</p>}
              </div>
              <div className="mt-auto">
